        ...
        <div class="col-md-10 mx-auto">
            <div class="card my-5">
                ...
                <div class="card header">
                    ...
                    <div class="card-body">
                        <form action="{{route('jeunes.store')}}" method="POST" class="mt-3">
                            @csrf
                            <div>
                            ...
                            <div>
                                ...
                                <input type="date" name="datenaissance" class="form-control" placeholder="DateNaissance" value="{{old('datenaissance')}}">
                            </div>
                            <div>
